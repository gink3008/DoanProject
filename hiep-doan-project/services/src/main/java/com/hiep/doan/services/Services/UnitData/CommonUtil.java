...
package com.hiep.doan.services.Services.UnitData;
...
import com.hiep.doan.services.Services.UnitData.domain.SearchParams;
...
public class CommonUtil {
	...
	public static boolean containUnicode(String str) {
		String signChars = "ăâđêôơưàảãạáằẳẵặắầẩẫậấèẻẽẹé�?ểễệếìỉĩịíò�?õ�?óồổỗộố�?ởỡợớùủũụúừửữựứỳỷỹỵý";
		if ("".equals(str)) {
			return false;
		} else {
			int count = 0;
